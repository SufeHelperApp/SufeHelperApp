...
public class Selection2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.item_explore:
                        Intent intent2 = new Intent(Selection2.this, ExploreActivity.class);
                        intent2.putExtra("user_now", user);
                        startActivity(intent2);
                        break;
                    case R.id.item_my:
                        Intent intent3 = new Intent(Selection2.this, My_HomeActivity.class);
        ...
        final String[] subtaskTypes = getResources().getStringArray(R.array.subtasks_skill);
